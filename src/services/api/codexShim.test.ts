...
describe('Codex request translation', () => {
  ...
  test('uses output_item.done arguments when stream argument deltas are incomplete', async () => {
    const responseText = [
      'event: response.output_item.added',
      'data: {"type":"response.output_item.added","item":{"id":"fc_1","type":"function_call","status":"in_progress","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\"","call_id":"call_1"},"output_index":0,"sequence_number":0}',
      '',
      'event: response.output_item.done',
      'data: {"type":"response.output_item.done","item":{"id":"fc_1","type":"function_call","status":"completed","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\",\\"description\\":\\"Look for regressions\\"}","call_id":"call_1"},"output_index":0,"sequence_number":1}',
      '',
      'event: response.completed',
      'data: {"type":"response.completed","response":{"id":"resp_1","status":"completed","model":"gpt-5.4","output":[{"type":"function_call","id":"fc_1","call_id":"call_1","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\",\\"description\\":\\"Look for regressions\\"}"}],"usage":{"input_tokens":2,"output_tokens":1}},"sequence_number":2}',
      '',
    ].join('\n')
    ...
    expect(inputJsonDeltas.join('')).toBe(
      '{"subject":"Search","description":"Look for regressions"}',
    )
  })

  test('falls back to call_id when output_item.done omits item.id', async () => {
    const responseText = [
      'event: response.output_item.added',
      'data: {"type":"response.output_item.added","item":{"id":"fc_1","type":"function_call","status":"in_progress","name":"TaskCreate","arguments":"","call_id":"call_1"},"output_index":0,"sequence_number":0}',
      '',
      'event: response.function_call_arguments.delta',
      'data: {"type":"response.function_call_arguments.delta","call_id":"call_1","delta":"{\\"subject\\":\\"Search\\"","sequence_number":1}',
      '',
      'event: response.output_item.done',
      'data: {"type":"response.output_item.done","item":{"type":"function_call","status":"completed","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\",\\"description\\":\\"Look for regressions\\"}","call_id":"call_1"},"output_index":0,"sequence_number":2}',
      '',
      'event: response.completed',
      'data: {"type":"response.completed","response":{"id":"resp_1","status":"completed","model":"gpt-5.4","output":[{"type":"function_call","id":"fc_1","call_id":"call_1","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\",\\"description\\":\\"Look for regressions\\"}"}],"usage":{"input_tokens":2,"output_tokens":1}},"sequence_number":3}',
      '',
    ].join('\n')
    ...
    expect(inputJsonDeltas).toEqual([
      '{"subject":"Search","description":"Look for regressions"}',
    ])
  })

  test('falls back to output_index when item.id and call_id are missing', async () => {
    const responseText = [
      'event: response.output_item.added',
      'data: {"type":"response.output_item.added","item":{"id":"fc_1","type":"function_call","status":"in_progress","name":"TaskCreate","arguments":""},"output_index":0,"sequence_number":0}',
      '',
      'event: response.function_call_arguments.delta',
      'data: {"type":"response.function_call_arguments.delta","output_index":0,"delta":"{\\"subject\\":\\"Search\\"","sequence_number":1}',
      '',
      'event: response.output_item.done',
      'data: {"type":"response.output_item.done","item":{"type":"function_call","status":"completed","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\",\\"description\\":\\"Look for regressions\\"}"},"output_index":0,"sequence_number":2}',
      '',
      'event: response.completed',
      'data: {"type":"response.completed","response":{"id":"resp_1","status":"completed","model":"gpt-5.4","output":[{"type":"function_call","id":"fc_1","name":"TaskCreate","arguments":"{\\"subject\\":\\"Search\\",\\"description\\":\\"Look for regressions\\"}"}],"usage":{"input_tokens":2,"output_tokens":1}},"sequence_number":3}',
      '',
    ].join('\n')
